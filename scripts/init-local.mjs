...
try {
  ...
  console.log(".env already exists. Existing adapter identity and secret were preserved.");
  process.exit(0);
} catch {
...
await writeFile(configurationFile, configuration, {encoding: "utf8", mode: 0o600, flag: "wx"});
...
console.log("Run npm start, then copy the adapter name, base URL, and secret into Self-hosted Office.");
